    ...
    <>
      <div className="doc-inspector">
          ...
          <div className="inspector-header-main">
            ...
            <div className="inspector-file-meta">
              ...
              <div className="inspector-file-sub">
                {isPdf ? "PDF" : isImage ? "Image" : "File"} · Status: Ready · Size: {sizeMb} MB
              </div>
            </div>
          </div>
          <div className="inspector-badge-current">Active</div>
        </div>
        ...
        <div className="inspector-ai-context">
          ...
          <span className="inspector-ai-text">IntelX is currently using this document for answers</span>
        </div>
